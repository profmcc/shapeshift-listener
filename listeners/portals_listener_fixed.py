...
Properly detects Portals affiliate fees based on the actual transaction pattern.
"""
...
class FixedPortalsListener:
    ...
    def run_listener(self, blocks_to_scan: int = 2000):
        ...
        logger.info("🚀 Starting Fixed Portals affiliate fee listener")
        ...
        logger.info(f"\n✅ Fixed Portals listener completed! Found {total_events} total events")
