#!/usr/bin/env python3
"""
Final Fixed Portals Affiliate Fee Listener
...
class FinalPortalsListener:
    ...
    def run_listener(self, blocks_to_scan: int = 2000):
        ...
        logger.info("🚀 Starting Final Portals affiliate fee listener")
        ...
        logger.info(f"\n✅ Final Portals listener completed! Found {total_events} total events")
...
def main():
    ...
    parser = argparse.ArgumentParser(description='Final Portals Affiliate Fee Listener')
